 ...
 * @LastEditTime: 2023-07-03 19:27:04
 * @LastEditors: weisheng
 * @Description:
 * @FilePath: \wot-design-uni\src\pages\pickerView\index.js
 * 记得注释
 */
...
Page({
  data: {
    ...
    columns5: [district[0], district[district[0][0].value], district[district[district[0][0].value][0].value]],
  ...
  onChange({ currentTarget: { dataset }, detail: { picker, value, index } }) {
    if (dataset.index === 1) {
