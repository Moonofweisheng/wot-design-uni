...
const list1 = computed(() => [
  {
    ...
    disabled: false,
    payload: {
      avatar: 'https://v1.wot-ui.cn/assets/redpanda.jpg'
    }
  },
  {
    value: t('han-mei-mei'),
    disabled: false,
    payload: {
      avatar: 'https://v1.wot-ui.cn/assets/capybara.jpg'
    }
  },
  {
    value: t('lin-tao'),
    disabled: true,
    payload: {
      avatar: 'https://v1.wot-ui.cn/assets/panda.jpg'
    }
  },
  {
    value: t('tom'),
    disabled: false,
    payload: {
      avatar: 'https://v1.wot-ui.cn/assets/meng.jpg'
    }
  }
])
