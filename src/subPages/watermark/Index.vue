  ...
  <view>
    <page-wraper>
      ...
      <demo-block :title="$t('ju-bu-shui-yin')">
        <wd-watermark :opacity="0.8" image="https://v1.wot-ui.cn/logo.png" :image-width="38" :image-height="38" :full-screen="false"></wd-watermark>
...
const image = computed(() => {
  return showImage.value ? 'https://v1.wot-ui.cn/logo.png' : ''
})
