...
export default {
  ...
  puzzleCaptcha: {
    title: 'بىخەتەرلىك تەكشۈرۈشى',
    placeholder: 'مۇزىك پارچىسىنى تاماملاش ئۈچۈن تۆۋەندىكى سىلىقلاشنى سۈرۈڭ',
    successText: 'تەستىقلاش مۇۋەپپەقىيەتلىك بولدى',
    failText: 'تەستىقلاش مەغلۇپ بولدى، قايتا سىناڭ'
  }
}
